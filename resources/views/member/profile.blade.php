            ...
            <div class="profile-top">
                ...
                <div class="profile-info">
                    <div class="profile-name">
                        <span id="displayName">Member Juan</span>
            ...
            <div class="section-body">
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value" id="infoEmail">juan.delacruz@example.com</div>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value" id="infoPronouns">She/Her</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal">
            ...
            <div class="modal-grid">
                <div class="modal-field" style="grid-column: span 2;">
                    ...
                    <input type="text" id="inputDisplayName" value="Member Juan">
                </div>
                <div class="modal-field" style="grid-column: span 2;">
                    <label>Role / Title</label>
                    <input type="text" id="inputRole" value="Club Member">
                </div>
            </div>
        ...
        <div class="modal">
            ...
            <div class="modal-grid">
                ...
                <div class="modal-field">
                    <label>Email</label>
                    <input type="email" id="inputEmail" value="juan.delacruz@example.com">
                </div>
                <div class="modal-field">
                ...
                <div class="modal-field" style="grid-column: span 2;">
                    ...
                    <input type="text" id="inputPronouns" value="She/Her">
                </div>
            </div>
            <div class="modal-actions">
