...
@section('content')
    ...
    <div id="createLogModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('coach.training.store') }}">
                @csrf
    ...
    <div id="editLogModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('coach.training.update', ['id' => '__ID__']) }}" id="editLogForm" data-action="{{ route('coach.training.update', ['id' => '__ID__']) }}">
                @csrf
                @method('PATCH')
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label>Distance (m)</label>
                            <input type="number" id="editDistance" name="distance" class="form-input">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label>Arrow Count</label>
                            <input type="number" id="editArrowCount" name="arrow_count" class="form-input">
                        </div>
                        <div class="form-group">
                            <label>Total Score</label>
                            <input type="number" id="editScore" name="total_score" class="form-input">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Coach Rating (1-5)</label>
    ...
    <div id="deleteLogModal" class="modal">
        <div class="modal-content modal-danger">
            ...
            <form method="POST" action="{{ route('coach.training.delete', ['id' => '__ID__']) }}" id="deleteLogForm" data-action="{{ route('coach.training.delete', ['id' => '__ID__']) }}">
                @csrf
                @method('DELETE')
